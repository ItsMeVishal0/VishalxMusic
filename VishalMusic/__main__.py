...
async def setup_bot_commands():
    ...
    try:
        ...
        LOGGER("VishalMusic").info("Bot commands set successfully!")

    except Exception as e:
        LOGGER("VishalMusic").error(f"Failed to set bot commands: {str(e)}")
...
async def init():
    ...
    LOGGER("VishalMusic.plugins").info("Successfully Imported Modules...")
    ...
    await app.stop()
    await userbot.stop()
    LOGGER("VishalMusic").info("Stopping Vishal Music Bot...🥺")

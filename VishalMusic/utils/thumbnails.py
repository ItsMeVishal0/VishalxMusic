...
FONT_REGULAR_PATH = "VishalMusic/assets/font2.ttf"
FONT_BOLD_PATH    = "VishalMusic/assets/font3.ttf"
...
async def gen_thumb(videoid: str):
    ...
    try:
        ...
        draw.text((28+1, 18+1), "VishalMusic", fill=TEXT_SHADOW, font=tl_font)
        draw.text((28, 18), "VishalMusic", fill=TEXT_WHITE, font=tl_font)

...
async def send_repo(_, message: Message):
    await message.reply_video(
        ...
        caption=(
            ...
            "🧡 ᴄʀᴇᴅɪᴛꜱ : <a href='https://t.me/VishalBots'>@VishalBots</a>"
        ),
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("📂 Management Bot", url="http://github.com/NoxxOP/VishalMusic"),
                    InlineKeyboardButton("📂 Music Bot", url="http://github.com/NoxxOP/VishalxMusic")
                ]
            ]
        ),
        supports_streaming=True,

...
from VishalMusic.core.call import Nand
...
from VishalMusic.utils.inline.help import help_pannel_page1, help_pannel_page2, help_pannel_page3, help_pannel_page4
from VishalMusic.utils.stream.autoclear import auto_clean
from VishalMusic.utils.thumbnails import gen_thumb
from config import (
    BANNED_USERS,
    SOUNCLOUD_IMG_URL,
    STREAM_IMG_URL,
...
async def fork_repo_callback(client, query):
    await query.message.edit_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🚀 Fᴏʀᴋ Rᴇᴘᴏ", url="https://github.com/NoxxOP/VishalMusic/fork"),
                    InlineKeyboardButton("⚡ Hᴇʀᴏᴋᴜ Dᴇᴘʟᴏʏ", url="https://dashboard.heroku.com/new?template=https://github.com/NoxxOP/VishalMusic")
                ],
                [
...
from VishalMusic.utils.inline.start import about_panel
from strings import get_string
...
from pyrogram import Client, filters
from pyrogram.types import InlineKeyboardMarkup
from VishalMusic.utils.inline.start import owner_panel
from strings import get_string
from config import BANNED_USERS
